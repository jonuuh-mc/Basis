...
//
//import io.jonuuh.core.lib.gui.elements.GuiContainer;
//import io.jonuuh.core.lib.config.setting.types.single.DoubleSetting;
//
//public class GuiSingleSliderOld extends AbstractGuiSlider/*<double[]>*/
//{
//    public GuiSingleSliderOld(GuiContainer parent, int xPos, int yPos, int width, int height, double min, double max, double[] startValues, boolean isVertical)
//    {
//        super(parent, xPos, yPos, width, height, min, max, startValues, isVertical);
//    }
//
//    public GuiSingleSliderOld(GuiContainer parent, int xPos, int yPos, int width, int height, double min, double max, double startValue, boolean isVertical)
//    {
//        super(parent, xPos, yPos, width, height, min, max, startValue, isVertical);
//    }
//
//    public GuiSingleSliderOld(GuiContainer parent, int xPos, int yPos, double min, double max, double[] startValues)
//    {
//        super(parent, xPos, yPos, min, max, startValues);
//    }
//
//    public GuiSingleSliderOld(GuiContainer parent, int xPos, int yPos, double min, double max, double startValue)
//    {
