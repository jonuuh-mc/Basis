package io.jonuuh.basis.lib.config;

import io.jonuuh.basis.lib.config.setting.Settings;
import io.jonuuh.basis.lib.config.setting.types.Setting;
import io.jonuuh.basis.lib.config.setting.types.array.BoolArrSetting;
import io.jonuuh.basis.lib.config.setting.types.array.DoubleArrSetting;
import io.jonuuh.basis.lib.config.setting.types.array.IntArrSetting;
import io.jonuuh.basis.lib.config.setting.types.array.StringArrSetting;
import io.jonuuh.basis.lib.config.setting.types.single.BoolSetting;
import io.jonuuh.basis.lib.config.setting.types.single.DoubleSetting;
...
import io.jonuuh.basis.lib.util.logging.ChatLogger;
import io.jonuuh.basis.lib.util.logging.ChatLoggerManager;
import io.jonuuh.basis.lib.util.logging.Level;
