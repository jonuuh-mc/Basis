package io.jonuuh.basis.v000309.lib.config;
...
import io.jonuuh.basis.v000309.lib.config.setting.types.array.BoolArrSetting;
import io.jonuuh.basis.v000309.lib.config.setting.types.array.DoubleArrSetting;
import io.jonuuh.basis.v000309.lib.config.setting.types.array.IntArrSetting;
import io.jonuuh.basis.v000309.lib.config.setting.types.array.StringArrSetting;
import io.jonuuh.basis.v000309.lib.config.setting.types.single.BoolSetting;
import io.jonuuh.basis.v000309.lib.config.setting.types.single.DoubleSetting;
...
import io.jonuuh.basis.v000309.lib.util.logging.Level;
...
public final class SettingsConfigurationAdapter
{
    ...
    public void saveConfiguration()
    {
        ...
        ChatLogger chatLogger = ChatLoggerManager.getLogger("basis");
        if (chatLogger != null)
        {
