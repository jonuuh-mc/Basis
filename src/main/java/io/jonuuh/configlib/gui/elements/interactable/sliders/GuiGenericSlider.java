...
//
//public class GuiGenericSlider<T> extends GuiInteractableElement
//{
...
//
//    public GuiGenericSlider(ISettingsGui parent, int xPos, int yPos, int width, int height, float radius, double min, double max, double start)
//    {
...
//    }
//
//    public GuiGenericSlider(ISettingsGui parent, int xPos, int yPos, double min, double max, double start)
//    {
//        this(parent, xPos, yPos, 100, 10, 2, min, max, start);
//    }
//
//    public GuiGenericSlider(ISettingsGui parent, int xPos, int yPos, double min, double max)
//    {
